...
fn no_connect(){
    ...
    let dist_vector = distance_vector(0, &graph);
    let total_dist = total_distance(dist_vector, 3);
...
fn always_pos(){
    ...
    let dist_vector = distance_vector(0, &graph);
    let total_dist = total_distance(dist_vector, 6);
...
fn one_connect(){
    ...
    let dist_vector = distance_vector(0, &graph);
    let total_dist = total_distance(dist_vector, 2);
